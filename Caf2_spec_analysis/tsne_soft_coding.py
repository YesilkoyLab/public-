...
def main():
    foldername_list = ['caf2_col1','caf2_col1_4_8020/'] #'1000B', '1000', '9010', '8020', '7030', '6040'
    filename_list = ['LMT_1','LMT_2','LMT_3'] # ,'HMT_3','HMT_4','HMT_5','HMT_6','HMT_7'
    
    base_path = "../res/03232026_colle1+4/2nd"
    save_path = "../res/03232026_colle1+4/2nd/result/"
