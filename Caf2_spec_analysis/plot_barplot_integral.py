...
csv_path = r"../res/03232026_colle1+4/org/spectrum_fitting_results/subspectrum_fitting_results.csv"
...
try:
    ...
    # File Name | Peak Center | Height | FWHM | Integral Value
    if df.shape[1] >= 5:
        df = df.iloc[:, :5].copy()
        df.columns = ["File Name", "Peak Center", "Height", "FWHM", "Integral Value"]
    else:
...
# =========================================================
g1, g2 = "caf2_col1", "caf2_col1_4_8020"
...
plt.title(f"Average integral per component: collagen1 vs collagen1:4 80:20")
