...
def main():
    ...
    foldername_list = ['caf2_col1','caf2_col1_4_8020'] #'6040SER','6040PSER',, '8020SER','8020PSER','9010SER','9010PSER','7030SER','7030PSER','1000'
    sub_folder_list = {'LMT_1','LMT_2','LMT_3'} #,'LMT_2'

    for fl in foldername_list:
        for sub in sub_folder_list:
            folder = f'../res/03232026_colle1+4/org/{fl}/{sub}'
            save_subfolder = '../res/03232026_colle1+4/org/mean_spec/'
